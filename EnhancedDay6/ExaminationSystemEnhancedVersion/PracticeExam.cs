namespace ExaminationSystemEnhancedVersion
{
    ...
    {
        public PracticeExam(int time, int numberOfQuestion, Dictionary<Question, AnswerList> examQuestions, Subject subject, Student subjectInfo) : base(time, numberOfQuestion, examQuestions, subject, subjectInfo)
        {
        }
        ...
        public override void ShowExam()
        {
            ...
            foreach (KeyValuePair<Question, AnswerList> item in examQuestions)
            {
                ...
                Console.WriteLine($"The correct Answer is: {item.Value.numberOfCorrectAnswer}");
